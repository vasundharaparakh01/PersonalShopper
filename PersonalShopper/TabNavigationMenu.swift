...
//        itemIconView.backgroundColor = .clear
        ...
        NSLayoutConstraint.activate([
            ...
            itemIconView.topAnchor.constraint(equalTo: tabBarItem.topAnchor, constant: 14), // Position menu item icon 8pts from the top of it's parent view
