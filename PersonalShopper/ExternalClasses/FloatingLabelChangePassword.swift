...
class FloatingLabelChangePassword: UITextField {
    ...
    @IBInspectable
    var activeBorderColor: UIColor = UIColor.red
    @IBInspectable
    var floatingLabelFont: UIFont = UIFont(name:"Montserrat-Bold",size:14) ?? UIFont.systemFont(ofSize: 14) {
        didSet {
