...
public final class DropDown: UIView {
	...
	*/
    @objc public dynamic var cornerRadiusDropDown = DPDConstant.UI.CornerRadius {
		willSet {
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.cornerRadius = cornerRadiusDropDown
		...
		tableView.layer.cornerRadius = cornerRadiusDropDown
